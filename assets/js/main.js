$(document).ready(function() {
	$('#fullpage').fullpage({
		...
		afterLoad: function(anchorLink, index){
			if(index == 2){
				$('.me__col').addClass('active');
				$('figure').addClass('active');
			}

		},
		onLeave: function(index, newIndex, direction){
			$('.me__col').toggleClass('active', (index == 2 && direction == 'down' ) || (index == 4 && direction == 'up'));
			$('figure').toggleClass('active', (index == 2 && direction == 'down' ) || (index == 4 && direction == 'up'));
		},
		'navigation': true,
